...
public class MoneyUtils {
  ...
  public static String twoDecimalPlaces(Money money) {
    return twoDecimalPlaces(money, RoundingMode.HALF_UP);
  }

  /**
   * 获取值并保留两位小数.
   */
  public static String twoDecimalPlaces(Money money, RoundingMode roundingMode) {
    BigDecimal bigDecimal = BigDecimal.valueOf(Double.valueOf(money.getNumber().toString()));
